...
<head>
    ...
    <title>About us | Rajvishu Infra Constech Pvt.Ltd</title>
...
<body>
    ...
    <div class="body-wrapper">
        ...
        <div class="ltn__breadcrumb-area text-right bg-overlay-white-30 bg-image " data-bs-bg="img/bg/14.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-5 align-self-center">
                        <div class="about-us-img-wrap about-img-left">
                         <img src = "img/national-highway-44.jpg">
                    ...
                    <div class="col-lg-7 align-self-center">
                        <div class="about-us-info-wrap">
                            <div class="section-title-area ltn__section-title-2--- mb-20">
                                <h1 class="section-title">About Rajvishu Infra Constech Pvt.Ltd<span>.</span></h1>
                                <strong>We deliver high-quality, cost-effective projects on schedule</strong>
                                <p>Rajvishu Infra Constech Pvt Ltd is a leading construction company based in India.
Established in 2022. we have built a strong reputation for delivering high-quality projects on time and within budget.
Our expertise spans a wide range of construction services, from residential and commercial buildings to infrastructure development.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- CATEGORY AREA START -->
        <div class="ltn__category-area ltn__product-gutter section-bg-1 section-bg-1--- pt-50 pb-50">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <div class="ltn__testimonial-area section-bg-1--- bg-image-top pt-50 pb-50" data-bs-bg="img/bg/23.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-area ltn__section-title-2--- text-center---">
                    ...
                    <div class="col-lg-4">
                        <div class="ltn__testimonial-item ltn__testimonial-item-7 ltn__testimonial-item-8">
                            <div class="ltn__testimoni-info">
                                ...
                                <i>Rajvishu Infra Constech Pvt.Ltd is very spacious. It provides a wonderful fusion of hill sides and Urban life. All season's availability of fresh air and light even in rainy season makes it unique. It is available at very reasonable price. Life here is very happy and peaceful.</i>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
