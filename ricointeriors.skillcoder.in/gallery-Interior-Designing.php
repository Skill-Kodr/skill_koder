...
<head>
    <meta charset="UTF-8">
    <title>Interior |  Rico Interior</title>
            ...
            <div>
                <div class="uk-flex uk-flex-center filter-design-sc">
                    <ul id="filter" class="filter">
                        ...
                        <li class="check-class uk-active"><a href="gallery-fabricks.php">Awnings</a></li>
                        ...
                        <li class="check-class"><a href="gallery-finished-kitchen.php">Window Blinds</a></li>
                ...
                <div class="wrap-gallery">
                    <ul id="gallery_member" class="uk-grid grid">
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/1.jpg" alt="">
                        ...
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/2.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/3.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/4.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/5.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                        ...
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/6.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/7.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/8.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/gallery/fabricks/fabrick_1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/gallery/Interior-Designing/9.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
