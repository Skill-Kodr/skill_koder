...
<head>
    <meta charset="UTF-8">
    <title>Mattress |  Rico Interior</title>
        ...
        <div class="uk-container uk-container-center">
            <div>
                ...
                <ul id="filter" class="filter">
                        ...
                        <li class="check-class uk-active"><a href="gallery-mattress.php">Wallpaper</a></li>
                ...
                <div class="wrap-gallery">
                    <ul id="gallery_member" class="uk-grid grid">
                        <li data-src="images/wall1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                        ...
                        <li data-src="images/wall2.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                        ...
                        <li data-src="images/wall3.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/wall3.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/wall4.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/wall4.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
