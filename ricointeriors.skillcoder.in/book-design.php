...
<head>
    <meta charset="UTF-8">
    <title>Book Design |  Rico Interior</title>
            ...
            <div class="kc-box">
                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-1-1 uk-width-small-1-1 uk-width-1-1">
                                        <label>
                                            <select class="input-text">
                                                <option selected="Modular Kitchen ">Modular Kitchen </option>
                                                ...
                                                <option value="Kitchen Furniture">Kitchen Appliances</option>
                                            </select>
                                        </label>
                                    </div>
                                    <div class="uk-width-medium-1-1 uk-width-small-1-1 uk-width-1-1">
                    ...
                    <div class="uk-width-medium-1-2 uk-width-small-1-1 uk-width-1-1">
                        ...
                        <div class="text-code">
                            <button class="kc-button kc-button-primary">Submit enquiry</button>
                        </div>
                    </div>
                </div>
            </div>
