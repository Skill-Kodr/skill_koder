...
<head>
    <meta charset="UTF-8">
    <title>Finished Kitchen |  Rico Interior</title>
...
<body>
    ...
    <section class="inner-banner sec-padding">
        <div class="uk-container uk-container-center">
            <div class="box uk-clearfix">
                <h2>Finished Kitchen</h2>
                <!-- <ul class="uk-breadcrumb">
                    <li><a href="index.php">Home</a></li>
                    <li><span>Gallery</span></li>
                    <li><span>Finished Kitchen</span></li>
                </ul> -->
            </div>
        </div>
    </section>
    <section class="designs sec-padding sec-background gallery gallery-masonry">
        <div class="uk-container uk-container-center">
            <!-- <div class="sec-title">
                <h3>Our Finished Kitchen</h3>
                <div class="border-img"></div>
            </div> -->
            <div>
                <div class="uk-flex uk-flex-center filter-design-sc hidden-xs">
                <ul id="filter" class="filter">
                        <li class="check-class"><a href="gallery-kitchen-appliances.php">Curtain Rods</a></li>
                        <li class="check-class"><a href="gallery-godrej-kitchen.php">Curtain Channel</a></li>
                        <li class="check-class"><a href="gallery-mattress.php">Wallpaper</a></li>
                        <li class="check-class"><a href="gallery-wallpaper.php">Mosquito Nets</a></li>
                        <li class="check-class"><a href="gallery-fabricks.php">Awnings</a></li>
                        <li class="check-class"><a href="gallery-furnishing.php">Flooring Carpet</a></li>
                        <li class="check-class"><a href="gallery-tata-steel.php">False Ceiling</a></li>
                        <li class="check-class"><a href="gallery-flooring.php">ICU Curtain</a></li> 
                        <li class="check-class uk-active" ><a href="gallery-finished-kitchen.php">Window Blinds</a></li>
                ...
                <div class="wrap-gallery">
                    <ul id="gallery_member" class="uk-grid grid">
                        <li data-src="images/win1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/win1.jpg" alt="">
                        ...
                        <li data-src="images/win2.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/win2.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/win3.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/win3.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/win4.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/win4.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
