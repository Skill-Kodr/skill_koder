...
<head>
    <meta charset="UTF-8">
    <title>Flooring |  Rico Interior</title>
        ...
        <div class="uk-container uk-container-center">
            <div>
                ...
                <ul id="filter" class="filter">
                        ...
                        <li class="check-class uk-active"><a href="gallery-flooring.php">ICU Curtain</a></li> 
                ...
                <div class="wrap-gallery">
                    <ul id="gallery_member" class="uk-grid grid">
                        <li data-src="images/icu1.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/icu1.jpg" alt="">
                        ...
                        <li data-src="images/icu2.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/icu2.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/icu3.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/icu3.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
                        ...
                        <li data-src="images/icu4.jpg" class="grid-item uk-width-medium-1-4 uk-width-small-1-2 uk-width-1-1 design-item">
                            <div class="uk-overlay uk-overlay-hover uk-animation-hover">
                                <img src="images/icu4.jpg" alt="">
                                <div class="uk-overlay-panel uk-overlay-background  uk-flex uk-flex-middle uk-flex-center uk-animation-scale-up">
                                    <div class="box">
                                        <div class="box-icon">
                                            <a href="#"><span class="icon uk-icon-search"></span></a>
