                                ...
                                <div class="col-xl-12">
                                    <div class="card mb-4">
                                        <div class="card-header">
                                          <i class="fas fa-marker"></i>  <b> Update Teacher Detail</b>
                                            ...
                                            <div class="box_general padding_bottom">
                                                <div class="wrapper_indent">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="teacher_name" value="<?php echo $row['teacher_name']; ?>" class="form-control" placeholder="Enter Teacher Full Name">
                                                    </div>
                                                        ...
                                                        <div class="row">                                                           
                                                            <div class="col-xl-9 ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label>Email</label>
                                                                            <input type="email" class="form-control" placeholder="Enter Email Id" name="email" value="<?php echo $row['email_id']?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label>Subject</label>
                                                                            <input type="text" class="form-control" placeholder="Enter Subject Name" name="subject" value="<?php echo $row['subject']?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea id="editor1" name="editor1">  <?php echo $row['desc']; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                 </div>
                                                            </div>
                                                            <div class="col-xl-3">
                                                                <div class="dropzone"  style="width:180px; height: 200px;">
                                                                    <img src="teacherimages/<?php echo $row['teacher_image']; ?>" class="img-fluid">
                                                                </div>
                                                                <input type="file" value="<?php echo "teacherimages/".$row['teacher_image']; ?>" class="form-control" name="profile">
                                                            </div>
                                                        </div>
