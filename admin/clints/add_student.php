            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <form action="add_student_db.php" method="POST" name="addproduct" enctype="multipart/form-data">
                            <div class="row mt-5">
                                <div class="col-xl-12">
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            <i class="fas fa-box mr-1"></i> <b> Add Student Detail </b>
                                            ...
                                            <div class="box_general padding_bottom">
                                                <div class="wrapper_indent">
                                                                ...
                                                                <div class="row">                                                                   
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter Class In Which Admission Sought" name="admission_sounght" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <!-- <input type="text" class="form-control" placeholder="Enter Class Name" name="class" required> -->
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label>DOB*</label>
                                                                            <div>
                                                                            <input type="date" id="datePickerId"  value="<?php echo date("Y-m-d")?>"  class="form-control"  name="dob">
                                                                            </div>
                                                                        </div>
                                                                    </div> 
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter Mother's Name" name="mother_name" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label>Father's Name*</label>
                                                                            <input type="text" class="form-control" placeholder="Enter Father's Name" name="father_name" required>
                                                                        </div>
                                                                    </div>                                                                   
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                        <label>Educational Qualification (Father) *</label>
                                                                            <input type="text" class="form-control" placeholder="Enter Father's Qualification" name="father_qualification" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label>Educational Qualification (Mother) *</label>
                                                                            <input type="text" class="form-control" placeholder="Enter Mother's Qualification" name="mother_qualification" required>
                                                                        </div>
                                                                    </div>                                                                    
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                        <label> Occupation(Father)*</label>
                                                                            <input type="text" class="form-control" placeholder="Enter Father's Occupation" name="father_occupation" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label> Occupation(Mother)*</label>
                                                                            <input type="text" class="form-control" placeholder="Enter Mother's Occupation" name="mother_occupation" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Enter Natioality" name="nationality" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                    ...
                                                    <div class="text-center mb-4 mt-4">
                                                        <input type="submit" name="submit" class="bnt btn-success  btn-lg" value="Add Student ">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
