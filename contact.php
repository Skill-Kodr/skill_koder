                        ...
                        <div class="contact-us-info1">
                            <ul>
                                <li>
                                    ...
                                    <h3>Phone</h3>
                                    <p>+917507548060 ,9304829922, 6202669551</p>
                                </li>
                                <li>
                                    <i class="fa fa-map-marker" aria-hidden="true"></i>
                                    <h3>Address</h3>
                                    <p>Rameshwar Bazar 3rd floor Kalwan Nashik-423501 Maharashtra</p>
                                </li>
                                <li>
                                    <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                    <h3>E-mail</h3>
                                    <p>info@skillcoder.in</p>
                                </li>
                                <li>
                                    <h3>Follow Us</h3>
                                    <ul class="contact-social">
                                        <li><a href="https://www.facebook.com/profile.php?id=61565193200493" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li><a href="https://www.youtube.com/@skill_koder" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                                        <li><a href="https://www.instagram.com/skill_codr/" target="_blank"><i class="fa fa-instagram " aria-hidden="true"></i></a></li>
